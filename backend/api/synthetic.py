...
Mirrors the device simulator so models learn the same baseline distribution
they see in production. Keep in sync with ``simulation/worker.py`` generation
logic.
"""
...
def generate_normal_traces(
    ...
    ``detectors.isolation_forest.FEATURE_ORDER``."""
